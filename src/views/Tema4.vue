    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      .col-lg.order-2.order-lg-1.p-md-0.esptop
        .cajon.color-primario.p-5.mb-4(style='background-color: #F0F1F5') 
          p.col-11.mb-3 La imagen del iceberg representa la documentación relacionada con el product backlog, pequeño en la parte de arriba, con las historias ya reducidas, con tamaño mediano en la parte central y más grande y desconocido por debajo con sus historias épicas. De esta manera, se podría representar el product backlog, algo inesperado y desconocido que se puede presentar durante el desarrollo del proyecto.
